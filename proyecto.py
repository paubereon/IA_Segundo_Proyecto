...
#EMPEZAMOS EL PROYECTO DE IMAGENES
import os
...
st.set_page_config(
    page_title="RECONOMIENTO DE PRODUCTOS",
    page_icon = ":smile:",
...
with st.sidebar:
        st.image('productos.jpg')
        st.title("Reconocimiento de imagen")
        st.subheader("Reconocimiento de imagen de los 10 productos")

st.image('logo.png')
st.title("Universidad Autónoma de Bucaramanga - UNAB")
st.write("Paula Betina Reyes Anaya")
st.write("""
         # El proyecto consiste que pueda reconocer automáticamente 10 productos diferentes al tomar una foto. Utiliza el reconocimiento de imagen para identificar y clasificar cada uno de los productos capturados en la fotografía.
